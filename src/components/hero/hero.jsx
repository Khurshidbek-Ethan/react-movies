		...
		<div className='hero'>
			<div className='hero__info'>
				...
				<p>
					...
					Repellat sunt necessitatibus veritatis labore provident
					similique neque praesentium debitis maiores. Nihil
					consectetur, veniam labore magnam ab similique optio
